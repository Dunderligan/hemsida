	...
	const typeClass = $derived(
		disabled
			...
			: {
					...
					tertiary: 'text-gray-600 font-medium hover:bg-gray-50 underline',
...
<svelte:element
	...
	class={[
		...
		'flex items-center justify-center gap-2 rounded-lg transition-all duration-200 ease-in-out'
	]}
	{disabled}
	{href}
	{...props}
